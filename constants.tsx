...
export const INITIAL_EMAIL_TEMPLATES: EmailTemplate[] = [
    ...
    },
    {
        ...
        body: `<div style="font-family: Arial, sans-serif; color: #333; max-width: 600px; margin: auto; border: 1px solid #eee; border-radius: 8px;">
                  <div style="background-color: #f8f8f8; padding: 20px; text-align: center; border-bottom: 1px solid #eee;">
                    <img src="https://storage.googleapis.com/lolirinepoolstoreimage/Blue%20Waves%20Surfing%20Club%20Logo.png" alt="Lolirine Pool Store Logo" style="max-width: 150px;" />
                  </div>
                  <div style="padding: 30px;">
                    <h1 style="color: #0891b2; font-size: 24px;">Bienvenue, {{customerName}} !</h1>
                    <p style="font-size: 16px; line-height: 1.5;">
                      Nous vous remercions de votre inscription sur Lolirine Pool Store. Votre compte a été créé avec succès.
                    </p>
                    <p style="font-size: 16px; line-height: 1.5;">
                      Pour finaliser votre inscription et continuer vos achats ou votre processus de paiement, veuillez cliquer sur le bouton ci-dessous.
                    </p>
                    <div style="text-align: center; margin: 30px 0;">
                      <a href="/" target="_blank" style="background-color: #06b6d4; color: white; padding: 15px 25px; text-decoration: none; border-radius: 8px; font-weight: bold; font-size: 16px;">
                        Continuer et finaliser ma commande
                      </a>
                    </div>
                    <p style="font-size: 16px; line-height: 1.5;">
                      Si vous avez des questions, n'hésitez pas à nous contacter.
                    </p>
                    <p style="margin-top: 30px; font-size: 16px; line-height: 1.5;">
                      Cordialement,<br/>
                      L'équipe Lolirine Pool Store
                    </p>
                  </div>
                  <div style="background-color: #f8f8f8; padding: 20px; text-align: center; border-top: 1px solid #eee; font-size: 12px; color: #777;">
                    <p>&copy; ${new Date().getFullYear()} Lolirine Pool Store. Tous droits réservés.</p>
                  </div>
                </div>`,
        type: 'lifecycle',
        enabled: true,
