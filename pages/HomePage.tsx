...
const HeroSection: React.FC<{ navigateTo: HomePageProps['navigateTo'] }> = ({ navigateTo }) => (
    <section className="relative h-[60vh] md:h-[80vh] bg-cover bg-center text-white" style={{ backgroundImage: "url('https://storage.googleapis.com/lolirinepoolstoreimage/IMAGES%20ARRIERES%20PLAN/Piscine%20arrie%CC%80re%20plan3.jpg')" }}>
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-4">
            <img src="https://storage.googleapis.com/lolirinepoolstoreimage/Blue%20Waves%20Surfing%20Club%20Logo.png" alt="Lolirine Pool Store" className="h-24 md:h-32 mb-4"/>
            <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight leading-tight mb-8" style={{ textShadow: '2px 2px 8px rgba(0,0,0,0.7)' }}>
                Des piscines comme on les aime !
            </h1>
            <button 
                onClick={() => navigateTo('shop')}
                className="bg-cyan-500 hover:bg-cyan-600 text-white font-bold py-3 px-8 rounded-lg text-lg transition duration-300 transform hover:scale-105 shadow-lg"
            >
                Découvrez les produits
            </button>
            <div className="mt-8 max-w-3xl mx-auto text-lg md:text-xl" style={{ textShadow: '1px 1px 4px rgba(0,0,0,0.8)' }}>
