      ...
      <div className="bg-gray-900 py-8">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center text-gray-400 text-sm">
          <button onClick={() => navigateTo('home')}>
            <img src="https://storage.googleapis.com/lolirinepoolstoreimage/Blue%20Waves%20Surfing%20Club%20Logo.png" alt="Lolirine Pool Store" className="h-10 mx-auto mb-6 opacity-80 hover:opacity-100 transition-opacity"/>
          </button>
