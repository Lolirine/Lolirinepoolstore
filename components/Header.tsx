...
export const Header: React.FC<HeaderProps> = (props) => {
  const { currentPage, navigateTo, cartItemCount, wishlistItemCount, onCartClick, currentUser, onLoginClick, onRegisterClick, onLogoutClick, bannerConfig, menuConfig } = props;
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex items-center h-20">
                ...
                <div className="flex items-center gap-4 ml-auto">
                     ...
                     >
                        <button onClick={() => currentUser ? setIsUserMenuOpen(!isUserMenuOpen) : onLoginClick()}
                            ...
                            <div className="text-left text-xs">
                                ...
                                <p className="font-bold leading-tight flex items-center">{currentUser ? 'Compte et listes' : 'Se connecter'} <ChevronDown size={14}/></p>
                            </div>
                        </button>
                        {isUserMenuOpen && (
                             <div className="absolute right-0 mt-1 w-56 bg-white rounded-md shadow-lg py-2 z-50 text-gray-700">
                                {currentUser ? (
                                <>
                                  ...
                                  <div className="p-2">
                                     ...
                                     <p className="text-xs text-center mt-2">Nouveau client ? <button onClick={onRegisterClick} className="text-cyan-600 hover:underline">Commencez ici.</button></p>
                                  </div>
                                )}
                             </div>
                        )}
